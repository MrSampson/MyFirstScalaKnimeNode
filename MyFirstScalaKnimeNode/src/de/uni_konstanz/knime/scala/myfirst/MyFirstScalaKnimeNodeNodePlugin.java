 ...
 */
public class MyFirstScalaKnimeNodeNodePlugin extends Plugin {
    // The shared instance.
    private static MyFirstScalaKnimeNodeNodePlugin plugin;

    /**
     * The constructor.
     */
    public MyFirstScalaKnimeNodeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MyFirstScalaKnimeNodeNodePlugin getDefault() {
        return plugin;
    }
